...
class ApiClient:
    ...
    def send_event(self, event_payload):
        ...
        # ---- Minimal safety checks (non-breaking) ----
        if "binId" not in event_payload or "eventType" not in event_payload:
            print("[API] Invalid payload: missing binId or eventType")
            return False
        ...
        try:
            response = requests.post(
                ...
                json=event_payload,          # ✅ use json= (cleaner, safer)
